...
/* $Id: registration.h,v 1.1 2005/03/24 05:32:02 phi196 Exp $ */
 ...
 *
 * Revision 1.2  2004/11/10 05:51:41  phi196
 * Compilation fix
 *
...
#define RCSID(file, id) static char rcsid_##file[] __attribute__ ((unused)) = id;
/* static void *use_rcsid_##file = (&use_rcsid_##file, (void *)&rcsid_##file) */

RCSID(registration_h, "$Id: registration.h,v 1.1 2005/03/24 05:32:02 phi196 Exp $");
